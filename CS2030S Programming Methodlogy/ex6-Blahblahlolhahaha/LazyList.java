 ...
 * @version CS2030S AY 25/26 Sem 2
 *
 */
class EagerList<T> {
   ...
   *
   * @param i The index of the element to retrieve (0 for the 1st element).
   ...
   * @return The index of the element in the list.  -1 if element is not in the list.
   */
